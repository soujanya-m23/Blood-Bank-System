                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Blood group Table</h6>
                            <a href="category_form.php" class="btn btn-danger">Add Blood Group </a>
                            <br>
                            <br>
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    while ($crow = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <td>
                                            <?php echo $crow['category_status']; ?>
                                        </td>


                                        <td><a href="edit_category.php?sid=<?php echo $crow['category_id']; ?>"

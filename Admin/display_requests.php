                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $admin->ret("SELECT * FROM `donor` INNER JOIN `category` ON donor.category_id=category.category_id INNER JOIN `blood_requests` ON donor.donor_id=blood_requests.donor_id INNER JOIN `user` ON user.user_id=blood_requests.user_id");
                                    while ($crow = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <!-- <td>
                                            <a href="../donor_signup.php"><i class="bi bi-plus-circle-fill btn-md"

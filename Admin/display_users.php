                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $admin->ret("SELECT * FROM `user` INNER JOIN `category` ON user.category_id=category.category_id");
                                    while ($crow = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <td><a href="controller/delete_donor.php?did=<?php echo $crow['user_id']; ?>"

...
<body class="main-layout">
   ...
   <div class="full_bg1">
      <br>
      <h3><b><i>DONATE BLOOD SAVE LIFE....</i></b></h3>
      <!-- header inner -->
      <div class="section">
         <!-- carousel code -->
            ...
            <div class="carousel-inner">
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row">
                        <div class="col-md-8">
                           <div class="photog text-center">
                              <!-- <a class="read_more btn btn-rounded btn-danger font-weight-bold" href="donor_signin.php" style="font-size: 18px">Save a life!</a> -->
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="row d_flex grid">
            ...
            <div class="col-md-5 oder1">
               <div class="titlepage text_align_left">
                  <h2>"Give Life: Boost Awareness"</h2>
                  <p>When we donate blood, it removes 225 to 250 milligrams of iron from our body, hence reducing the
                     risk of heart disease.Blood Center performs numerous tests on the donated blood. Therefore regular
                     blood donation helps in sheilding us from serious diseases.
                  </p>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage text_align_center">
                  ...
                  <p>Give blood, give plasma, share life, share often. It focuses on patients requiring life-long
                     transfusion support and underlines the role every single person can play, by giving the valuable
                     gift of blood or plasma.
                  </p>
               </div>
            </div>
         </div>
                     ...
                     <div class="item">
                        <div class="protect_box text_align_center">
                           <div class="desktop">
                              ...
                              <h3>Bloodline Harmony</h3>
                              <span>
                                 "Generations united through the heart of blood donation."</span>
                           </div>
                     ...
                     <div class="item">
                        <div class="protect_box text_align_center">
                           <div class="desktop">
                              ...
                              <h3> Donate Blood</h3>
                              <span> Preserve Blood, Preserve Life</span>
                           </div>
                     ...
                     <div class="item">
                        <div class="protect_box text_align_center">
                           <div class="desktop">
                              ...
                              <h3>"Gift of Blood: Life's Elegance"</h3>
                              <span> Drop by drop, we weave life's beauty through blood donation.
